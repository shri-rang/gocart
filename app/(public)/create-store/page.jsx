...
export default function CreateStore() {
            ...
            if(['approved','rejected', 'pending'].includes(data.status) ){
                ...
                switch (data.status) {
                    case "approved":
                         ...
                         break;
                    case "rejected":
                         setMessage("Your store request has been approved, contact the admin for more details")
    ...
    if(!user){
     return ( <div className="min-h-[80vh] mx-6 flex items-center justify-center text-slate-400"  >
